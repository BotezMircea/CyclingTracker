...
import com.mircea.botez.sql.DBHelper;
...
public class RegisterActivity extends AppCompatActivity implements View.OnClickListener{
    ...
    private void postDataToSQLite(View view) {
        if(!InputValidation.isTextInputEmpty(textInputEditTextName, textInputLayoutName, getString(R.string.error_message_name))) {
            return;
        }
        ...
        if(!InputValidation.validatePasswords(textInputEditTextPassword, textInputEditTextConfirmPassword, textInputLayoutConfirmPassword, getString(R.string.error_password_match))) {
            return;
        }
        ...
        try {
            ...
            if(!userHelper.checkUserByEmail(textInputEditTextEmail.getText().toString(), this)) {
